...
def process_arguments():
    ...
    parser.add_argument("--sid", type=int, help="ID of the sample(0 to 1643)", default=random.randint(0, 100), required=False)
...
def main():
    ...
    sample = json.loads((pathlib.Path(__file__).parent / "data/dev.json").read_text())[sample_id]
    ...
    outputs = infer_model.generate(
        inputs, do_sample=False, num_beams=1, temperature=None, top_p=None, pad_token_id=tokenizer.pad_token_id, max_new_tokens=512
    )
